...
export default function CertificateSelectorPage() {
  // Load data synchronously since it's now static
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {certificates.map((cert) => (
        ...
        >
          <div className="certificate-card rounded-2xl p-6 h-[300px] flex flex-col hover:scale-105 transition-all duration-300 group">
